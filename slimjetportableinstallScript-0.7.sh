...
curl  "https://www.slimjet.com/en/dlpage.php" --output dlpage.php
# if dlpage.php = "" then exit
...
echo "$curver"
 # if $curver = "" then exit 
 #rm slimjet_amd64.tar.xz
#wget -4c http://www.slimjetbrowser.com/release/slimjet_amd64.tar.xz
curl  http://www.slimjetbrowser.com/release/slimjet_amd64.tar.xz  --output slimjet_amd64.tar.xz


# if slimjet_amd64.tar.xz = "" then exit 
...
curl https://raw.githubusercontent.com/aarf/puppylinux/master/prespotslim --output prespotslim
